...
class GALLER{ //gagama ug class nga ang ngalan kay GALLER
...
void GALLER::twovarswapping() //process sud sa function
...
void GALLER::threevarswapping() //process sud ani nga function
